...
#### Given a sequence of DNA **(dna.txt)** and a CSV file containing STR counts for a list of individuals **(dna.csv)**, dnay.py outputs to whom the DNA (most likely) belongs.
